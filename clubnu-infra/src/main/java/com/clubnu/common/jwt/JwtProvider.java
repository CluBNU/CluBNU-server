...
public class JwtProvider {
    ...
    public JwtToken provideTokens(Long sub, UserRole role, Nationality nationality, RegistStatus registStatus) {
        Claims claims = makeAccessClaims(sub, role, nationality, registStatus);
    ...
    private Claims makeAccessClaims(Long sub, UserRole role, Nationality nationality, RegistStatus registStatus) {
        Claims claims = Jwts.claims();
        claims.setSubject(Long.toString(sub));
        claims.put("role", role);
        claims.put("nationality", nationality);
        claims.put("regist_status", registStatus);
        return claims;
    }
